 ...
 * @param {function} fnOrString function to inject args into and run.
 * @param {object} thisArg Calling context.
 * @returns {*} Returns the result of the called function.
 */
MagnumDI.prototype.inject = function(fnOrString, thisArg) {

  if(_.isString(fnOrString)){
    return this.dependencies.get(fnOrString)
  }
  ...
  var args = fnOrString.toString().match(FUNC_ARGS)[1].split(',');
  ...
  return fnOrString.apply(thisArg, depArray)
}
